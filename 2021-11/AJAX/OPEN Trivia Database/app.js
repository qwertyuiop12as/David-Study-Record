...
function generateURL() {
  ...
  if (input_number.value < 1 || input_number.value > 50) {
    console.log("Please Choose a number between 1 and 50!");
    return;
  }
  ...
  questionList["total"] = input_number.value;
...
function choiceClicked(e) {
  ...
  if (e.target.classList[0] == "game__choice" && questionList["token"] == true) {
    showAnswer(e.target);
